...
import org.utilkit.UtilKit;
import org.utilkit.time.SharedTimer;
...
class SharedTimerInstance extends Timer
{
	...
	public function every(seconds:Number, callback:Function):void
	{
		...
		if (callbacks.indexOf(callback) == -1)
		{
			...
			UtilKit.logger.debug("SharedTimer added every callback for every " + seconds + "s");
		}
	}
	...
	protected function onTimer(e:TimerEvent):void
	{
		...
		if (this._everyCallback != null)
		{
			...
			if (triggered > 0)
			{
				//UtilKit.logger.debug("SharedTimer triggered " + triggered + " callbacks with 'every' subscriptions.");
			}
		}
	}
}